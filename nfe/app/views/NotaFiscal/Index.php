<div class="conteudo-fluido">
			...
			<div class="caixa-titulo py-1 d-flex justify-content-space-between">
                <span class="h5  pt-1 mb-0 d-inline-block"><i class="far fa-list-alt"></i> Lista de Notas Fiscais</span>
				<div>
					<a href="<?php echo URL_BASE ."notafiscal/create"?>" class="btn btn-verde  d-inline-block"><i class="fas fa-plus-circle mb-0"></i> Adicionar novo</a>
						...
						<table cellpadding="0" cellspacing="0" id="dataTable">
                            <thead>
                                <tr>
									...
									<th align="left" width="270">Cliente</th>                                   
                            ...
                            ?>                      
								<tr>
									...
									<td align="center"><?php echo $nota->em_CNPJ ?></td>									
									...
									<td align="center">
										...
										<a href="<?php echo URL_BASE . "emitente/excluir/" .$emitente->id_emitente ?>" class="d-inline-block btn btn-outline-vermelho btn-pequeno"><i class="fas fa-trash-alt"></i> Excluir</a>
									</td>
								</tr>                    
							<?php } ?>	             
