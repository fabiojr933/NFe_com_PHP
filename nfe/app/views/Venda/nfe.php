					...
					<div class="col-12">
						<div class="tabela-responsiva px-0">
							<table cellpadding="0" cellspacing="0" id="dataTable">
								...
								<tbody>
									<?php foreach ($nfe as $nf) { ?>
										<tr>
											<td align="center"><?php echo $nf->id_nfe ?></td>
											<td align="left"><?php echo $nf->dest_xNome ?></td>
											<td align="center"><?php echo $nf->vLiq ?></td>
											<td align="center">
												<a href="<?php echo URL_BASE . "nfe/gerarNfe/" . $nf->id_nfe ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> GerarXML</a>
												<a href="<?php echo URL_BASE . "nfe/assinarNfe/" . $nf->id_nfe ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> assinar Nfe</a>
												<a href="<?php echo URL_BASE . "nfe/enviarNfe/" . $nf->id_nfe ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Enviar e autorizar Nfe</a>
												<a href="<?php echo URL_BASE . "nfe/autorizaNfe/" . $nf->id_nfe ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> autorizar Nfe</a> 
